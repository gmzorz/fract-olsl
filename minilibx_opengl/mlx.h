...
void	*mlx_new_fragment_program(int width, int height, const char *title, const char *shader_src);
int		mlx_fragment_add_skybox(void *prog, void *buffer, int width, int height, const char *name);
int		mlx_fragment_start_loop(void *prog);
void	mlx_fragment_catch_pixels(void *prog, int (*func)(void *));
/*
** dealing with Events
*/
